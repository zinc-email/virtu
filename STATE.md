...
Last updated: 2026-08-22 (invite lane — ABUSE.md Tier 0: `invites` table,
`SIGNUP_INVITE_ONLY` graduation gate in /auth/verify, `/api/admin/invites`
mint/list/revoke + AdminInvites page + Login invite flow, `bin/invite-create`).
Companion to `PLAN.md` (the design
